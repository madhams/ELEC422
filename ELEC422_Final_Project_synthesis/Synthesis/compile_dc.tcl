...
set my_verilog_files [list top_mod_new.v dp.v main_FSM.v decoder.v encoder.v key_gen.v MC.v s_box.v r_box.v reverse_MC.v SR.v]

#/* Top-level Module Name update                            */
set my_toplevel top_mod_new
